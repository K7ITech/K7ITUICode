...
if (
  ...
  if (
    ...
    for (var i = 0; i < shadowCardsRounded.length; i++) {
      ...
      (el = shadowCardsRounded[i].nextElementSibling).style.backgroundImage =
        "url(" + currentSrc + ")";
    }
  if (shadowCards)
          ...
          function () {
            ...
            if (o.classList.contains("flex-column")) {
              ...
              (s.style.transform = "translate3d(" + e + "px, 0px, 0px)"),
                (s.style.width =
                  o.querySelector("li:nth-child(" + a + ")").offsetWidth +
                  "px");
            }
          };
      }
      ...
      if (r) {
        ...
        if (t.classList.contains("flex-column")) {
          ...
          (l.style.transform = "translate3d(0px," + e + "px, 0px)"),
            (l.style.width =
              t.querySelector("li:nth-child(" + a + ")").offsetWidth + "px"),
